    ...
    def __init__(self, value=''):
        while True:
            ...
            if value:
                ...
                self.values = input(SystemPresent().present(
    ...
    def __init__(self, value=''):
        while True:
            if value:
                ...
                self.value = input(SystemPresent().present(
            ...
            try:
                ...
                PresentErrors().present('Incorrect date! Please provide correct date format.')
    ...
    def __init__(self, value=''):
        while True:
            ...
            if value:
                ...
                self.value = input(SystemPresent().present("Email: "))
            try:
                ...
                PresentErrors().present('Incorrect email! Please provide correct email.')
    ...
    def __init__(self, value=''):
        while True:
            ...
            try:
                ...
                PresentErrors().present('There is no such status!')
